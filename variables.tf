...
variable "windows_worker_node_count" {
  type        = number
  description = "Number of windows worker nodes to create in public subnets"
  default     = 1
}
...
variable "windows_associate_public_ip_address" {
  type        = bool
  description = "Map a public IP address for Windows instances"
  default     = true
}
...
variable "license_server_count" {
  type        = number
  description = "Number of license servers to create in public subnets"
  default     = 1
}

variable "webapp_server_count" {
  type        = number
  description = "Number of license servers to create in public subnets"
  default     = 1
}

variable "transformation_server_count" {
  type        = number
  description = "Number of license servers to create in public subnets"
  default     = 1
}

variable "reporting_server_count" {
  type        = number
  description = "Number of license servers to create in public subnets"
  default     = 1
}

variable "integration_server_count" {
  type        = number
  description = "Number of license servers to create in public subnets"
  default     = 1
}
